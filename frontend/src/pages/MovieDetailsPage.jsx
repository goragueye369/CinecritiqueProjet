      ...
      try {
        ...
        if (searchResults && searchResults.results && searchResults.results.length > 0) {
          ...
          movieInfo = {
            ...
            image: tmdbMovie.poster_path ? getImageUrl(tmdbMovie.poster_path, 'w500') : 'data:image/svg+xml;base64,PHN2ZyB3aWR0aD0iNTAwIiBoZWlnaHQ9Ijc1MCIgeG1sbnM9Imh0dHA6Ly93d3cudzMub3JnLzIwMDAvc3ZnIj48cmVjdCB3 disagree=IjUwMCIgZmlsbD0iIzJhMmEyYSIvPjx0ZXh0IHg9IXQ4JSIgeT0iNTAlIiB0ZXh0LWFuY2hvcj0ibWlkZGxlIiBkeT0iLjNlbSIgZmlsbD0iIzk5OTk5OSIgZm9udC1zaXplPSIxOCIgZm9udC1mYW1pbHk9IkFyaWFsIHNhbnMtc2VyaWYiPkltYWdlIG5vbiBkaXNwb25pYmxlPC90ZXh0Pjwvc3ZnPg==',
